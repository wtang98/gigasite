                ...
                <div className="services__container--landing">
                    ...
                    <div className="services__container--landing__description">
                        ...
                        <div className="text">
                            {
                                {
                                    Eng: "Our strategies and tailored approach across all asset classes enable us to achieve our clients needs and goals. We actively monitor our offerings with the objective to outperform the benchmark returns in every situation.",
